...
export const PROJECTS: ProjectDetail[] = [
  ...
  },
  {
    ...
    title: 'Ship2Anywhere',
    category: 'Dev',
    tags: ['Angular 17', 'Node.js', 'Multi-carrier'],
    year: '2024',
    image: 'assets/images/projects/s2a-hero.jpg',
    wide: true,
    tagline: 'Australia\'s multi-carrier shipping platform — 70+ carriers, 10,000+ customers, ISO 27001 certified.',
    heroImage: 'assets/images/projects/s2a-hero.jpg',
    section1Image: 'assets/images/projects/s2a-s1.png',
    bandImage: 'assets/images/projects/s2a-band.jpg',
    section2Image: 'assets/images/projects/s2a-s2.png',
    quote: '"Global logistics made effortless — one platform, 70+ carriers, every shipment tracked."',
    meta: [
      { label: 'Client', value: 'Ship2Anywhere' },
      { label: 'Location', value: 'Melbourne, AU' },
      { label: 'Stack', value: 'Angular 17 · Node.js' },
      { label: 'Cert', value: 'ISO 27001' },
    ],
    section1: {
      title: 'Multi-Carrier Platform & Shipping Engine',
      body: 'Developed the technology backbone of Ship2Anywhere — Australia\'s leading multi-carrier shipping platform serving 10,000+ customers across domestic and international logistics. Built an Angular-powered operations dashboard connecting merchants to 70+ carrier services with instant rate calculation, shipment booking, and real-time tracking from a single interface.',
      deliverables: ['Multi-Carrier Rate Engine', 'Shipment Booking Flow', 'Carrier API Integrations', 'Real-time Tracking'],
    },
    section2: {
      title: 'Ecommerce Integrations & Automation',
      body: 'Delivered plugin integrations for Shopify, WooCommerce, Magento, and VTEX — automating order import, carrier selection, and label printing for B2C and B2B merchants. The S2A Driver Direct module handles high-volume national express freight and bulky goods, while the Amazon FBA merchant support and Freight Insure integration round out an enterprise-grade fulfilment platform.',
      deliverables: ['Shopify & WooCommerce Plugins', 'Automated Label Printing', 'Amazon FBA Support', 'Freight Insurance Integration'],
    },
  },
];
